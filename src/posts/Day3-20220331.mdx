...
There was a small section of the trail where I got decent enough service to finally send out the blog posts for day 1 and 2. I should really look into further compressing the photos I upload. Each one is around 2MB and trying to send 30MB of data through a Git push on my phone with spotty coverage is a pain in the ass.
